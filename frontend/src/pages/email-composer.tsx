import { Mail, Download, Eye, Clock, Search, Send, ChevronRight, ArrowLeft, Reply, Forward, Mic, Plus } from "lucide-react";
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center gap-2 sm:gap-3 h-auto min-h-[3.5rem] px-3 sm:px-5 py-2 border-b border-border bg-surface-elevated shrink-0 flex-wrap">
        <Mail className="h-4 w-4 text-gold shrink-0 hidden sm:block" />
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Button
            ...
            onClick={() => navigate("/app?mode=email")}
          >
              ...
              <button
                ...
                className={`group flex items-center gap-3 w-full px-3 sm:px-4 py-3 rounded-lg text-left transition-all cursor-pointer ${
                  selectedContact?.email === contact.email
                    ...
                    : "bg-card border border-border hover:shadow-soft hover:border-gold/20"
                }`}
              >
                  ...
                  <div className="space-y-2">
                    {selectedContact.emails.map((email) => (
                      <button
                        ...
                        className="group flex items-center gap-4 w-full px-4 py-4 rounded-lg bg-card border border-border hover:shadow-soft hover:border-gold/20 transition-all text-left"
                      >
